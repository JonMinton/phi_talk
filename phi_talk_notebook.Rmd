...
The dataset has many observations (though they may be synthetic), and so I'm going to create a variant with far fewer observations too
...
So, from height alone, it's twice as likely I'm male than female, if using the full dataset, and about 60% more likely I'm make if using the small sample.
