...
2. Bayes Factors, as distinct from Neyman-Pearson Hypothesis Testing frameworks
...
Null distribution with only 10 observations
...
Null distribution with 100 observations
...
Null distribution with all 10 000 observations
...
bf_schedule %>% 
  ...
  labs(x = "Miles per gallon", 
       y = "Bayes factor (>1: more likely manual)"
  )
...
Get summaries of male and female means and standard deviations
...
Calculate Bayes Factor Schedules
...
The schedule based on only 10 observations 

```{r}

brks <- c(0.0001, 0.001, 0.01, 0.1, 1, 10, 100, 1000, 10000)

lbs <- c("1:10,000", "1:1000", "1:100", "1:10", "Even", "10:1", "100:1", "1000:1", "10,000:1")

tiny_bf_schedule %>% 
  ggplot(aes(x = height_vals, y = bf)) + 
  geom_line() + 
  scale_y_log10(breaks = brks, labels = lbs) +
  geom_hline(yintercept = 1) +
  labs(x = "Height in inches",
       y = "Bayes factor (> Even means more likely male)",
       title = "Bayes Factor of gender given height (10 observations)")
...
small_bf_schedule %>% 
  ...
  labs(x = "Height in inches",
       y = "Bayes factor (> Even means more likely male)",
       title = "Bayes Factor of gender given height (100 observations)")
```
...
bf_schedule %>% 
  ...
  labs(x = "Height in inches",
       y = "Bayes factor (> Even means more likely male)",
       title = "Bayes Factor of gender given height (10,000 observations)")
```
